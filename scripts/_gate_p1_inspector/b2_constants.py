...
# --- Scope-disclaimer labels (make the read-only, partial scope explicit) ---
SCOPE_REPRESENTATIVE_DEP_ONLY: Final[str] = "REPRESENTATIVE_STATIC_DEPENDENCY_INVENTORY_ONLY"
SCOPE_NOT_FULL_REPO_CERT: Final[str] = "NOT_FULL_REPOSITORY_DEPENDENCY_CERTIFICATION"
SCOPE_PIPELINE_OBSERVED_NOT_EXECUTED: Final[str] = "STATIC_PIPELINE_PATH_OBSERVED_NOT_EXECUTED"
SCOPE_NOT_ML_HARNESS_READY: Final[str] = "NOT_ML_HARNESS_READY"
B2_SCOPE_DISCLAIMERS: Final[tuple[str, ...]] = (
