...
def resolve_candidate(path: Any) -> Path:
    ...
    namespace and **relative spellings** outright; any resolution failure
    refuses rather than proceeding with an unresolved spelling.
    ...
    candidate = Path(normalise_spelling(text))
