...
def verify_unit_consistency(record: dict[str, Any]) -> dict[str, Any]:
    ...
    exempt = {
        ...
        #: it.
        "penetration_pips",
        #: Track 2's unit-free quantities: HTTP and provenance counts, the
        #: date-audit's rates, the offset in hours, and the Stage 1 counts and
        #: diagnostics. Named one by one rather than hidden behind a `_unit`
        #: marker on an enclosing dict, for the reason this list already gives.
        "attempts",
        "bytes",
        "extracted",
        "status",
        ...
        "year",
        "n_rows",
        "n_rows_in_panel_spans",
        "n_non_usd_rows",
        "n_usable",
        "n_series_compared",
        "n_comparable_pairs",
        "n_previous_equals_prior_actual",
        "n_official",
        "n_official_total",
        "n_official_vintages",
        "n_archive_dates",
        "n_archive_rows",
        "n_archive_rows_total",
        "n_matched",
        "n_matched_total",
        "n_rows_on_an_official_date",
        "n_rows_on_an_official_date_total",
        "agreement",
        "recall",
        "precision",
        "pooled_agreement",
        ...
        "runner_up_agreement",
        "best_offset_hours",
        "offset_hours_applied",
        "offset_hours_from_stage_0",
        "min_date_agreement_required",
        "exact_match_share",
        "exact_match_share_on_the_traded_families",
        "n_usable_on_the_traded_families",
        "share",
        "share_of_series_beating_the_naive_benchmark",
        "median_forecast_error_over_naive_error",
        "n_admissible_events",
        "n_admissible_events_total",
        "n_partial_days",
        "n_high_impact",
        "gross_exposure",
        "currency_breadth",
        ...
        "groups",
        "zero_net_direction",
        "no_following_trading_day",
        "thin_cross_section",
        "matching_a_family",
        "missing_actual_or_forecast",
        "zero_surprise",
        "admissible",
        "non_usd_rows",
