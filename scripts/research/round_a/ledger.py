...
LEDGER: Final[list[dict[str, Any]]] = [
    ...
    },
    {
        ...
        "status": (
            ...
            "DEVELOPMENT, accepted by Human + ChatGPT on 2026-09-14. It falsifies the "
            "pre-registered linear continuous currency expected-return architecture only; "
            "it is not FX_HAS_NO_EDGE. The efficiency bundle is "
            "TURNOVER_REDUCTION_MECHANISM_SUPPORTED, not ALPHA_SUPPORTED: architecture and "
            "turnover reduction cannot rescue a negative expected return"
        ),
    },
    {
        "id": "H-024",
        ...
        "target": (
            "the unfitted currency-level reversal rules (negated 5-, 20- and 60-day "
        ...
        "horizon_family": "5, 20 and 60 days only",
        ...
        "status": (
            "CLOSED - POST_HOC_EXPLORATORY_NON_DECISION_BEARING; scope limited to the 5-, "
            "20- and 60-day horizons and not generalised to others; not a candidate, not "
            "to be revived as a next main research track, and re-pre-registering or "
    ...
    },
    {
        ...
        "status": (
            ...
            "over public daily sovereign-yield data, simple fast and simple slow directional "
            "repricing, and subsequent G10 FX directional return. That closure forbids reviving "
            "the family with a 10/15/30/40/60-day lookback, an EWMA half-life sweep or threshold "
            "tuning, and does NOT reach OIS, the market-implied policy path, rate futures, "
            "intraday rate repricing, curve shape, term-premium information, rates options or "
            "distributional policy-path information, none of which has been observed. The "
            "accurate phrasing of the result is that roughly the same gross information was "
            "monetised with materially lower turnover, but stayed too close to break-even to "
            "establish a robust economic edge; it is NOT that slowing the measure strengthened "
            "the information. What is shown is non-monetisability at "
