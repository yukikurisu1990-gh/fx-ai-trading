...
PREREG: Final[dict[str, Any]] = {
    ...
    "screen": {
        ...
        "status_if_advance": "MARKET_YIELD_REPRICING_FAST_5D_MEASURE_DEVELOPMENT_CANDIDATE",
        "status_if_stop": "MARKET_YIELD_REPRICING_FAST_5D_MEASURE_NOT_SUPPORTED_IN_SEEN_DEVELOPMENT",
        "status_if_data_fails": "MARKET_YIELD_REPRICING_FAST_5D_MEASURE_DATA_NOT_DECISION_GRADE",
